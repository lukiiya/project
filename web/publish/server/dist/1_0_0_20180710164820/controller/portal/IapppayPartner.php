...
class IapppayPartner extends Base {
	private $common;
	private $resp;
	private $jsonView;
	...
	public function payNotify() {
		...
		$payNotifyResp = $iapppayPartner->payNotify();//验签过程
        ...
        //订单类型, 0=方案订单, 1=充值订单, 2=套餐订单, 3=出票订单, 4=彩金充值订单, 5=晒米冷热, 6=极限追盘
	...
	public function batchPayNotify() {
		$iapppayPartner = requireModule("IapppayPartner");
		$pay = requireModule("Pay");
		$batchPayNotifyResp = $iapppayPartner->batchPayNotify();//验签过程
