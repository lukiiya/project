...
class LecaiDLT {
    ...
    public function setIssuePrize() {
        ...
        foreach ($issueArr as $issue) {
            $result = $this->httpGet('http://baidu.lecai.com/lottery/draw/ajax_get_detail.php?lottery_type=1&phase='.$issue);
            ...
            $drawNumber = trim(implode('+', $ball));  //12,16,19,23,24+02,05
            ...
            //获取奖级
            $levelMap = array('prize25' => '一等奖', 'prize26' => '一等奖追加', 'prize27' => '二等奖', 'prize28' => '二等奖追加', 'prize29' => '三等奖', 'prize30' => '三等奖追加', 'prize31' => '四等奖', 'prize32' => '四等奖追加', 'prize33' => '五等奖', 'prize34' => '五等奖追加', 'prize35' => '六等奖', 'prize36' => '六等奖追加');
            ...
            if (empty($issue) || count($redBall) != 5 || count($blueBall) != 2 || empty($drawNumber) || !is_array($prize) || count($prize) <= 0) {
